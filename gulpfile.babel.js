...
const dev = series(clean, parallel(ejs, style, script, scriptPlugin, copyBootstrapIcons, copyBootstrapIconsFonts, copyImages), openBrowser);

export default dev;

exports.build = series(clean, parallel(ejs, style, script, scriptPlugin, copyBootstrapIcons, copyBootstrapIconsFonts, copyImages));
